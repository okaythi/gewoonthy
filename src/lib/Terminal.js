...
class Terminal {
  ...
  printMOTD() {
    ...
    this.printLine(` * Documentation:  <a href="https://github.com/okaythi/gewoonthy" target="_blank" rel="noopener noreferrer" style="color: var(--ubuntu-blue); text-decoration: underline;">https://github.com/okaythi/gewoonthy</a>`, true);
    this.printLine(``);
